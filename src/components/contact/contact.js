...
export default (props) => {
  ...
  //   if (firstName.length > 0 && lastName.length > 0 && verifyEmail(email) && message.length > 0) {
  //     setSubmitted(true);
  //   }
  // }
    ...
    return (
      <div className="content_div_type3">
        ...
        {/* <div className='text_input_box'>
          ...
          <div className="dual_input_div">
            <div className="input_div_sub" id="dual_input_div1">
              <input type="text" id="firstName" name="firstName" onChange={(event) => setFirstName(event.target.value)}></input>
            ...
            <div className="input_div_sub">
              <input type="text" id="lastName" name="lastName" onChange={(event) => setLastname(event.target.value)}></input>
              <div className="box_title">
                <h3>Last Name</h3>
              </div> 
            </div> 
        ...
        {/* <div className='text_input_box'>
          ...
          <div className="input_div_sub">
            <input type="text" id="subject" name="subject" onChange={(event) => setSubject(event.target.value)}></input>
          </div>
        </div>  */}
        <div className={submitted ? 'text_input_box_hidden' : 'text_input_box'}>
          <div className="box_title">
        ...
        {/* <div className='submit_button_div'>
              <button onClick={() => submitForm(firstName, lastName, email, message)}>Send</button>
            </div> */}
        <div className={submitted ? 'send_button_div_left_hidden' : 'send_button_div_left'}>
          {/* <button className='book_button' onClick={() => submitForm(firstName, lastName, email, message)}>Send</button> */}
